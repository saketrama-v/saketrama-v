...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=800&color=A78BFA&center=true&vCenter=true&multiline=false&width=700&lines=Building+AI+that+actually+does+something.;Vision+Transformers.+React.+Flask.+Python.;2nd+Year+CSE+%40+MIT+Manipal.;Open+to+internships+%E2%80%94+let%27s+build+something.)](https://git.io/typing-svg)
...
I'm a 2nd-year CS student who builds things that work in the real world — from deepfake detectors using Vision Transformers to AI bill splitters. I care about shipping, not just learning.
...
- `Python` `TensorFlow` `Keras` `Next.js` `Flask` `Jupyter`

---

### 🧾 [SPLIT — AI Bill Splitter](https://github.com/saketrama-v/SPLIT) · [🔗 Live Demo](https://split-dun.vercel.app)
> Upload a receipt. Chat naturally. Everyone pays exactly what they owe.

- **Gemini Vision API** parses receipts from images in seconds
- Natural language assignment: *"I had the burger, Arjun had the pasta"*
- Real-time totals, manual edits, one-click WhatsApp/iMessage sharing
- `React` `TypeScript` `Vite` `Tailwind` `Gemini API` `Vercel`
...
```
🔒  [CLASSIFIED] — An AI project I'm deep in. Will drop it when it's ready.
📦  Learning DevOps: Docker, CI/CD pipelines, Linux server stuff
